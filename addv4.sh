...
add-ip() {
    ...
    echo -e "===================================="
    echo -e "  >>>>> LINK INSTALL <<<<<"
    echo -e " Jalanin Ini Dulu : apt install -y wget screen && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/Kulanbagong1/vps/main/main.sh && chmod +x main.sh && screen -S install ./main.sh "
    echo -e " Baru Yg Ini : wget https://raw.githubusercontent.com/Kulanbagong1/vps/main/update.sh && chmod +x update.sh && ./update.sh "
    echo -e "===================================="
